...
if __name__ == "__main__":
    ...
    ap.add_argument("--targets",   default=os.path.join(ROOT,"config/targets/global_45_targets.json"))
    ap.add_argument("--cloud",     default=os.path.join(ROOT,"config/cloud_reality/global_45_clouds.json"))
