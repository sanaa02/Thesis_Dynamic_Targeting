...
DEFAULT_TARGETS    = os.path.join(_ROOT, "config", "targets",
                                  "global_45_targets.json")
DEFAULT_CLOUD_JSON = os.path.join(_ROOT, "config", "cloud_reality",
...
def run_vizard_episode(args: argparse.Namespace) -> None:
    ...
    if not os.path.exists(model_path):
        ...
        # Custom objects to handle attention policy class loading
        import sys
        import numpy.core
